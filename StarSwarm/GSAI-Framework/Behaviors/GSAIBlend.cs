...
{
    private readonly List<(GSAISteeringBehavior behavior, float weight)> _behaviors = new List<(GSAISteeringBehavior behavior, float weight)>();
    private readonly GSAITargetAcceleration _accel = new GSAITargetAcceleration();
